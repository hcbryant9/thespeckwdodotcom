...
function getTextures(num) {
    return ['assets/images/emotionzine/FRONT.png', 'assets/images/emotionzine/INNERFRONT.png'].concat(
        new Array(num).fill().map((_, idx) => 'assets/images/emotionzine/' + (idx + 1) + '.png'),
        ['assets/images/emotionzine/BACK.png']
    );
}
