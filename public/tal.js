...
function getTextures(num) {
    return ['assets/images/tal/FRONT.png', 'assets/images/tal/INNERFRONT.png'].concat(
        new Array(num).fill().map((_, idx) => 'assets/images/tal/' + (idx + 1) + '.png'),
        ['assets/images/tal/BACK.png']
    );
}
