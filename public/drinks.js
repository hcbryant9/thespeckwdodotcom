...
function getTextures(num) {
    return ['assets/images/drinks/FRONT.png', 'assets/images/drinks/INNERFRONT.png'].concat(
        new Array(num).fill().map((_, idx) => 'assets/images/drinks/' + (idx + 1) + '.png'),
        ['assets/images/drinks/BACK.png']
    );
}
